...
load_dir = [DME_dir '/scripts/group_anal/parametric_modulation/pm_val/t-test'];
    ...
    for t= 1:length(analysis_type)
        ...
        for n= 1:length(name_models)
            ...
            for c = 1:length(contrast_name)
                ...
                matlabbatch{1,1}.spm.stats.results.spmmat = {[DME_dir '/GLM/parametric_modulation/pm_val/2nd-level/t-test/' name_models{n} '/' group{g} '/SPM.mat']};
