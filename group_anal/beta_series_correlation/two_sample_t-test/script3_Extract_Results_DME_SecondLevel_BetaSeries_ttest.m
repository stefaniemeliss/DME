...
load_dir = [DME_dir '/scripts/group_anal/beta_series_correlation/two_sample_t-test'];

name_models = {'SWWS_D' 'SWWS_Donly'};
contrast_list = {1 2};
...
for n= 1:length(name_models)
    ...
    for c = 1:length(contrast_name)
        ...
        for s = 1:length(sides)
            ...
            spm_out = [DME_dir '/GLM/beta_series_correlation/2nd-level/two_sample_t-test/' name_models{n} '/' sides{s} '_peak'];
            ...
            matlabbatch{1}.spm.stats.results.conspec.thresh = 0.005; % exploratory analysis
            ...
            %matlabbatch{1,1}.spm.stats.results.export{3}.tspm.basename = [contrast_name{c} '_thresholded_wholeBrain_FWEc'];
