...
for s = 1:length(subjects)
    ...
    moddir = [DME_dir '/GLM/glm1/1st-level/' SUBJ_ID '/'];
    mkdir(moddir);
    cd(moddir);
    % specify data_dir
    ...
    for i = 1:2 % for both sessions
        ...
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,i).multi{1,1} = [DME_dir '/scripts/GLM/glm1/Regress_glm1/' SUBJ_ID '_regress_glm1_s' num2str(i) '.mat'];
    ...
    cd(save_dir);
    eval(['save DME_FirstLevel_glm1_' SUBJ_ID '.mat matlabbatch']);
