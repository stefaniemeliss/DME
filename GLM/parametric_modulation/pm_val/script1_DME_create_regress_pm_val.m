...
save_dir = [DME_dir '/scripts/GLM/parametric_modulation/pm_val/Regress_pm_val/'];
mkdir(save_dir);
...
for s = 1:length(subjects)
    ...
    for sess = 1 : 2
        ...
        cd(save_dir);
        eval(['save '  subjects{s} '_regress_pm_val_s' num2str(sess) '.mat names onsets durations pmod']);
